...
export default {
  ...
  data() {
    return {
      ...
      data: [{ name: 'zerocat-', timestamp: new Date(), threadName: 'system-prompt-message', level: 'INFO', className: 'com.zerocat.AppRun' + ' :', body: 'Welcome, no log output~' }],
      // level
