    ...
    >
      <div ref="form">
          ...
          <div class="left flex-bwteen pt10">
            ...
            <div class="info">{{parseTime(data.createTime)}}</div>
          </div>
          <div class="left flex-bwteen pt10">
            <div class="desc">购买时间:</div>
            <div class="info">{{ parseTime(data.payTime) }}</div>
          </div>
          <div class="left flex-bwteen pt10">
          ...
          <div class="left flex-bwteen pt10">
            ...
            <div class="info">
              <span v-if="data.state=='101'">待付款</span>
              <span v-if="data.state=='201'">待发货</span>
              <span v-if="data.state=='301'">待收货</span>
              <span v-if="data.state=='401'">已完成</span>
            </div>
          </div>
          <div class="left flex-bwteen pt10">
